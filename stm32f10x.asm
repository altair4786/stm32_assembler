...
;
; Перед вызовом файла 
; определите тип камешка в проекте
; директивой GBLL. 
; Перед директивой должен стоять пробел или табуляция
;	GBLL    STM32F10X_CL
...
;
; Затем подключите этот файл к проекту директивой GET.
; Перед директивой должен стоять пробел или табуляция
;	GET		C:\ARM\Cortex-M3\stm32f10x.asm
;
...
RCC_CR_HSITRIM	EQU	0x00000080	; Internal High Speed clock trimming
...
; SystemTick
;
SYST_CSR EQU 0xE000E010		;RW	Privileged	[a]	SysTick Control and Status Register
SYST_RVR EQU 0xE000E014		;RW	Privileged	UNKNOWN	SysTick Reload Value Register
